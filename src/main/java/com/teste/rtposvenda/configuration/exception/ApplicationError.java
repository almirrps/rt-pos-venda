...
public enum ApplicationError {
    ...
    QUANTIDADE_PARCELA_INFERIOR("Quantidade Inferior", "40", "A quantidade de parcelas é inferior à existente."),
    ...
    ApplicationError(String scope, String code, String description) {
        this.scope = scope;
        this.code = code;
